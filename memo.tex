...
\section{Manipulating Data Files}
    ...
    {
        Extract everything from gzipped tar archive.;
...
\section{Shell}
    ...
    \subsection{Subshell}
        ...
        {
            Put the and run the command in background mode.;
...
\section{Permission Management}
    ...
    \subsection{User Management}
        ...
        \CommandEntry{sudo useradd -m <login\_name>}
        {
            ...
            It uses some default values stored in \texttt{/etc/default/useradd} to create up the user.
        }

        \CommandEntry{sudo useradd -D}
        {
            Peek the system default used for \texttt{useradd}.;
            Admin can place template files with the directory specified by \texttt{SKEL} field.
        ...
        \CommandEntry{sudo userdel <username>}
        {
            ...
            Add \texttt{-r} to remove user's home directory and mail directory, but this still won't remove other files that belong to the user.
        }
    ...
    \subsection{File Permission}
        ...
        \CommandEntry{sudo chown <new\_owner> <file>}
        {
            ...
            Use \texttt{-h} to apply changes to the symbolic links that point to \texttt{<file>};
        ...
        \CommandEntry{chgrp <new\_group> <file>}
        {
            ...
            User must own the file and must in \texttt{<new\_group>}
        }
