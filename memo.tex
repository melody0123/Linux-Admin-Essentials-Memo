...
\section{System Services Management}
    ...
    \CommandEntry{sudo systemctl disbale <service>}
    {
...
\section{Manipulating Data Files}
    ...
    \subsection{Gzip}
        ...
        \CommandEntry{gzip -d <gzip\_archive1 gzip\_archive2 \dots gzip\_archiven>}
        {
            ...
            Equivalent to \texttt{gunzip <gzip\_archive1, gzip\_archive2, \dots, gzip\_archiven>} while \texttt{gunzip} is a shell script which utilize \texttt{gzip -d}
        }
